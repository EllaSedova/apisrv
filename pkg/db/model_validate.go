...
func (a Author) Validate() (errors map[string]string, valid bool) {
	errors = map[string]string{}

	if utf8.RuneCountInString(a.Name) > 64 {
		errors[Columns.Author.Name] = ErrMaxLength
	}

	if utf8.RuneCountInString(a.Email) > 64 {
		errors[Columns.Author.Email] = ErrMaxLength
	}
